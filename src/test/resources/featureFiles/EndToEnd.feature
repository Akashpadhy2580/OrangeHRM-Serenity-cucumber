...
#    And I validate that I am on the Personal Details Page
    ...
    Examples:
      ...
      | Akash      | Kumar       | Padhy     | 1001        | aksh2580 | Enabled | Password@1234 | Password@1234    |
...
# Check login with the changed password
    ...
    Examples:
      ...
      | Abhash     | Kumar       | Padhy     | 1001        | abhash2580 | Enabled | Password@1234 | Password@1234    | Password@1234    |
...
#  Login with the same employee and validate if the user is able to login successfully
    ...
    Examples:
      ...
      | Sneha      | Rani        | Sahu      | 1001        | sneha2419 | Password@1234 | Password@1234    |
...
#    Login with same employee and validate that the user is able to logout
    ...
    Examples:
      | First Name | Middle Name | Last Name | Employee ID | Username | Password      | Confirm Password |
      | Akash      | Kumar       | Padhy     | 1001        | akash123 | Password@1234 | Password@1234    |
...
# Login as the same user that was added
    ...
    Examples:
      ...
      | Akash      | Kumar       | Padhy     | 1001        | ESS       | Akash Kumar Padhy | Enabled | akash1234 | Password@1234 | Password@1234    |
...
# Login with the Admin user that was created above
    ...
    Examples:
      ...
      | Akash      | Kumar       | Padhy     | 1001        | akash2419 | Password@1234 | Password@1234    | Akash Kumar   | Admin     | Enabled |
